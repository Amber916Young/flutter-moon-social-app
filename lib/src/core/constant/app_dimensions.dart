class Dimensions {
  ...
  static const double paddingSizeExtraLarge2 = 35.0;
  static const double paddingSizeExtraExtraLarge = 65.0;
  static const double paddingSizeOverLarge = 150;
  ...
  static const double radiusExtraSmall = 1.0;
